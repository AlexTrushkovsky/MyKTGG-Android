...
import ua.pp.trushkovsky.ktggauth.ui.news.d.BASE_NEWS_URL
...
class RecyclerAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val itemTitle: TextView = itemView.findViewById(id.title_news)
        val itemDetail: TextView = itemView.findViewById(id.text_news)
